...
XOrgUserHelper::XOrgUserHelper(const QString &serverCmd, const QProcessEnvironment &env, QObject *parent)
    : QObject(parent)
    , m_env(env)
                                  ...
                                  QProcess **p)
{
    ...
    // Make sure to forward the input of sddm-helper onto the Xorg
...
bool XOrgUserHelper::startServer()
{
    ...
    QProcessEnvironment serverEnv = m_env;
